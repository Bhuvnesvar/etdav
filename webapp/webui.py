...
from mac_helpers import generate_cert, trust_cert, needs_ssl, has_ssl
from .radicale.etesync_cache import etesync_for_user
from local_cache import Etebase
from config import LEGACY_ETESYNC_URL, ETESYNC_URL
...
def inject_user():
    import webapp
    return dict(version=webapp.__version__)
